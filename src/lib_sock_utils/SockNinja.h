...
public:
  ...
  void  disableWarningBadNMEALen()  {m_warning_bad_nmea_len  = false;}
  void  disableWarningBadNMEANend() {m_warning_bad_nmea_nend = false;}
  void  disableWarningBadNMEARend() {m_warning_bad_nmea_rend = false;}
  void  disableWarningBadNMEAForm() {m_warning_bad_nmea_form = false;}
  void  disableWarningBadNMEAChks() {m_warning_bad_nmea_chks = false;}
  void  disableWarningBadNMEAKey()  {m_warning_bad_nmea_key  = false;}
  
  bool  setIgnoreCheckSum(bool v) {m_ignore_checksum = v; return(true);}
  bool  getIgnoreCheckSum() {return(m_ignore_checksum);} 
...
protected:
  ...
  bool m_warning_bad_nmea_len;
  bool m_warning_bad_nmea_nend;
  bool m_warning_bad_nmea_rend;
  bool m_warning_bad_nmea_form;
  bool m_warning_bad_nmea_chks;
  bool m_warning_bad_nmea_key;
